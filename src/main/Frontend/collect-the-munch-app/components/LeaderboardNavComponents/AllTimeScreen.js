...
import { View, Text, StyleSheet, FlatList, Button, ActivityIndicator, Image, ScrollView } from 'react-native';
import axios from 'axios';
import { colors } from '../../Styles/theme';

function AllTimeScreen() {
  const initialLeaderboard = [
    { id: 1, fullName: 'Lily Pilly', userName: 'lily23', points: 12468, profileImage: require('../../assets/Images/Dalle.png') },
    ...
    { id: 5, fullName: 'User 5', userName: 'User 5', points: 6192 },
    { id: 6, fullName: 'User 6', userName: 'User 6', points: 1492 },
    { id: 7, fullName: 'User 7', userName: 'User 7', points: 447 },
    { id: 8, fullName: 'User 8', userName: 'User 8', points: 940 },
    { id: 9, fullName: 'User 9', userName: 'User 9', points: 1220 },
    { id: 10, fullName: 'User 10', userName: 'User 10', points: 957 },
    { id: 11, fullName: 'User 11', userName: 'User 11', points: 6170 },
    { id: 12, fullName: 'User 12', userName: 'User 12', points: 970 },
    { id: 13, fullName: 'User 50', userName: 'User 50', points: 4730},
    { id: 14, fullName: 'User 29', userName: 'User 29', points: 830 },
    { id: 15, fullName: 'User 57', userName: 'User 57', points: 800 },
    ...
    { id: 20, fullName: 'User 12', userName: 'User 12', points: 65 },
    { id: 21, fullName: 'Number one', userName: 'User 50', points: 4053 },
  ]
  ...
  useEffect(() => {
    ...
    /*
    axios.get(`https://your-api-url/AllTime?page=${currentPage}`)
      .then(response => {
